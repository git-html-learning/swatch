...
(function() {
    ...
    DrawingManager.prototype._addGeoUtilsLibrary = function () {
        if (!BMapLib.GeoUtils) {
            ...
            script.setAttribute('src', 'https://huiyan-fe.github.io/BMap-JavaScript-library/src/GeoUtils/GeoUtils.min.js');
    ...
    Mask.prototype.initialize = function (map) {
        ...
        div.style.cssText = 'position:absolute;cursor:crosshair;width:' + size.width + 'px;height:' + size.height + 'px';
        this._map.addEventListener('resize', function (e) {
            me._adjustSize(e.size);
        });
